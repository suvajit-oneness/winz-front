...
@Component({
  ...
  template: `
      ...
      <li routerLinkActive="active" *ngIf="teacherProfile"><a routerLink="/teacher/course/list"><i class="ti-agenda"></i> Your Courses</a></li>
      <!-- <li routerLinkActive="active" *ngIf="teacherProfile"><a routerLink="/user/chapter"><i class="ti-book"></i> Chapters</a></li> -->
      <li routerLinkActive="active" *ngIf="teacherProfile"><a routerLink="/booking-request"><i class="ti-bookmark-alt"></i> Booking Request</a></li>
      ...
      <li routerLinkActive="active" *ngIf="teacherProfile"><a routerLink="/schedule"><i class="ti-calendar"></i> Schedule</a></li>
      <li routerLinkActive="active" *ngIf="teacherProfile"><a routerLink="/events"><i class="ti-cup"></i> Events</a></li>
      <li routerLinkActive="active"><a routerLink="/chaper/purchase/history"><i class="ti-book"></i> Subscribed Chapter</a></li>
      <li routerLinkActive="active"><a routerLink="/user/membership"><i class="ti-id-badge"></i> Your Membership</a></li>
      <li routerLinkActive="active"><a routerLink="/user/zoom-meeting"><i class="ti-video-camera"></i> Zoom Meetings</a></li>
